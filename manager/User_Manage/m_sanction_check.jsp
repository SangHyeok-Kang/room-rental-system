        ...
        <nav class="navbar navbar-default">
            ...
            <div class="navbar-header">
                ...
                <div class="logo animated wow slideInLeft" data-wow-delay=".5s">
                    <a class="navbar-brand" href="../Home/manager.jsp">내방어때? <span>자취방대여플랫폼</span></a>
                </div>
            </div>
            ...
            <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li><a href="../Home/manager.jsp">Home</a></li>
                    </strong>
                    <li><a href="../Home/m_notice.jsp">공지사항관리</a></li>
                    <li><a href="../Home/m_contact.jsp">문의내역 관리</a></li>
                    <li class="active"><a href="../Home/m_users.jsp">사용자 관리</a></li>
                    <li><a href="../Home/m_refund.jsp">환불내역 관리</a></li>
                </ul>
            ...
            <div class="form_table" style="margin-top: 0px; float: left; width: 100%; position: relative;">
                <table class="tbl_type" border="1" cellspacing="0" style="width:100%">
                    ...
                    <tr>
                        ...
                        <th style="text-align: left;color:#333;text-align: center;background-color:#fef5ef;">신고자 아이디</th>
            ...
            <div style="float: left; width: 100%; text-align: center; margin-top: 3%; margin-bottom:15px;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <div class = sanction_butt>
                            <button style="width: 7%;margin-right: 2%;background-color: #ffd7b4;border: solid 2px #ff895c69;border-radius: 10px;">
                                <a style="color: black;" href="m_sanction_confirm.jsp?san_num=<%=rs.getInt("sanction_num")%>">승인</a>
                            </button>
                            <button style="width: 7%;margin-right: 2%;background-color: #ffd7b4;border: solid 2px #ff895c69;border-radius: 10px;">
                                <a  style="color: black;" href="m_sanction_reject.jsp?san_num=<%=rs.getInt("sanction_num")%>">거절</a>
                            </button>
                        </div>
                    <%}%>
                    </tbody>
