        ...
        <nav class="navbar navbar-default">
            ...
            <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="../Home/m_notice.jsp">공지사항 관리</a></li>
                    </strong>
                    <li class="active"><a href="../Home/m_contact.jsp">문의사항 관리</a></li>
                    <li><a href="../Home/m_users.jsp">사용자 관리</a></li>
    ...
    <div class="contact">
        <div class="tabs">
            ...
            <div class="form_table" style="margin-top: 0px; float: left; width: 100%; position: relative;">
                <table class="tbl_type" border="1" cellspacing="0" summary="쪽지쓰기" style="width: 100%";>
                    <colgroup>
                        <col style="width:15%">
