			...
			<nav class="navbar navbar-default">
				...
				<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
					...
					<div class="logo animated wow slideInLeft" data-wow-delay=".5s">
						<a class="navbar-brand" href="index.jsp">내방어때? <span>자취방대여플랫폼</span></a>
					</div>
				</div>
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						</strong><li class="active"><a href="index.jsp">Home</a></li>
						<li><a href="/jsp/error.jsp">방 등록</a></li>
						<li><a href="codes.jsp">방 검색 및 예약</a></li>
...
<!-- //header -->
	<!--비밀번호 찾기  -->
	<div class="container">
		<div class="find_pw" style="display:block">
			<form action = "/jsp/SearchPassword.jsp">
				<div class="find_title">
					<b>비밀번호 찾기 </b><br>
					<p style="text-align:right;">1.아이디 입력 > 2. 비밀번호 확인</p>
				</div>
				<div class="find_pw1"> 
