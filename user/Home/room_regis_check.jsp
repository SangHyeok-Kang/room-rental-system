...
<div class="contact">
	<div class="tabs">
    	...
    	<label class="tab_item" for="all" style="width: 100%;">방 등록 내역 </label>
    	...
    	<div class="tab_content" id="all_content">
      		<div class ="list_none" style="display:block;">
				<table class="board-table">
					<thead>
					<tr>
					   <th scope="col" class="th-num">사용자 번호</th>
					   <th scope="col" class="th-title">방 등록 번호</th>
					</tr>
					</thead>
					<tbody>
					 <% while(rs.next()){ %>
						 ...
						 <tr>
							 <td><%=rs.getInt("room.user_num")%></td>
							 <td class="title indent text-align-left"><a href="../room/Registration/room_check.jsp?room_number=<%=rs.getInt("room.room_num")%>"><%=rs.getInt("room.room_num") %></a></td>
							 <%}%>
