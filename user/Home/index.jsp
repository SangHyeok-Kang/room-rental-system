			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<li class="active"><a href="/user/Home/index.jsp">Home</a></li>
						<li><a href="/jsp/error.jsp">방 등록</a></li>
						<li><a href="/user/Home/codes.jsp">방 검색 및 예약</a></li>
				...
				<form action="/jsp/signup.jsp">
					<div class="signup">
						<div class = "idps">
							<div class = "id">
								<h5>ID</h5>
								<input class="date" name="id" id="id" type="text" placeholder="Insert your ID" required="" minlenght=6 maxlength=8>	
							</div>
							<div class = "ps">
								<h5>PASSWORD</h5>
								<input class="date" type="password" name="ps" id="ps" placeholder="insert your password" requried=""minlenght=6 maxlength=8>
							</div>
						</div>
						<div class = "name">
							<div class = "f_name">
								<h5>FIRST NAME</h5> 
								<input type="text" class = "name" name="firstname"id="firstname" placeholder="insert your fisrt name" required="">
							</div>
							<div class ="l_name">
								<h5>LAST NAME</h5>
								<input type="text" class="name" name="lastname" id="lastname" placeholder="insert your last name" required=""> 
							</div>
						</div>
						<div class="resi">
							<h5>RESIDENT</h5>
					 		<input type="text" name="birth" id="birth" required minlength= 6 maxlength=6>  - 
					 		<input type="password" name="resident" id="resident" required minlength= 7 maxlength=7>
						</div>
						<div class="phone">
							<h5>PHONE NUMBER</h5>
							<input type="text" name="phonenum" id="phonenum" required minlength = 3 maxlength=3> -
							<input type="text" name="phonenum2" id="phonenum2" required minlength = 4 maxlength=4> -
							<input type="text" name="phonenum3" id="phonenum3" required minlength = 4 maxlength=4>
						</div>
								...
								<tbody>
									<% while(rs.next()){ %>
										...
										<tr>
											...
											<td class="title indent text-align-left"><a href="/user/notice/notice_check.jsp?an_number=<%=rs.getInt("an_num")%>"><%=rs.getString("title") %></a></td>
