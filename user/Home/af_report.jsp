...
<%
	...
	String query=null;
		...
		stb.append("select * from user left outer join waiting_sanction on user.ID=waiting_sanction.user_id where waiting_sanction.user_id = \"").append (u_id).append("\""); 
		query = stb.toString();
...
<div class="contact">
	<div class="tabs">
    	...
    	<label class="tab_item" for="all">나의 신고 내역 </label>
    	<input id="programming" type="radio" name="tab_item">
    	<label class="tab_item" for="programming">새 신고 작성 </label>
      		...
      		<div class ="list_none" style="display:block;">
				<table class="board-table">
					...
					<tr>
					   ...
					   <th scope="col" class="th-user">승인여부</th>
					</tr>
					</thead>
					<tbody>
						<% while(rs.next()){ %>
							<tr>
								  ...
								  <td class="title indent text-align-left"><a href="../report/sanction_check.jsp?san_number=<%=rs.getInt("sanction_num")%>"><%=rs.getString("waiting_sanction.appro_user_id") %></a></td>
    	...
    	<div class="tab_content" id="programming_content">
			<div class="fcf-body">
    			<div id="fcf-form">
    				<h3 class="fcf-h3">신고 게시판 </h3><br>
    				<form id="fcf-form-id" class="fcf-form-class" action="../report/regi_report.jsp">
        			<div class="fcf-form-group">
            			<label for="Name" class="fcf-label">비매너 사용자 아이디 </label>
            			<div class="fcf-input-group">
                			<input type="text" id="Name" name="user" class="fcf-form-control" required
            				value placeholder="신고하려는 사용자의 아이디를 입력하세요.">
            			</div>
        			</div>
        			<div class="fcf-form-group">
            			<label for="Message" class="fcf-label"> 신고 내용 </label>
            			<div class="fcf-input-group">
                			<textarea id="Message" name="Message" class="fcf-form-control" rows="6" maxlength="3000" style="resize:none;" required
            				value placeholder="신고하실 내용을 작성해 주세요."></textarea>
            			</div>
        			</div>
        			<div class="fcf-form-group">
            			<button type="submit" id="fcf-button" class="fcf-btn fcf-btn-primary fcf-btn-lg fcf-btn-block">신고 제출</button>
        			</div>
    				</form>
    			</div>
			</div>
