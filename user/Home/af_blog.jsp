			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="/user/Home/af_blog.jsp">공지사항</a></li>
			   ...
			   <tbody>
				<% while(rs.next()){ %>
					...
					<tr>
						...
						<td class="title indent text-align-left"><a href="../notice/af_notice_check.jsp?an_number=<%=rs.getInt("an_num")%>"><%=rs.getString("title") %></a></td>
